...
router.put(
    "/givePoints",
    verifyToken.verifyToken(config.jwt.player.admin, config.jwt.player.label),
    usersMiddlewares.givePointsValidations(), usersController.givePoints);
...
router.put(
    "/updateName",
    verifyToken.verifyToken(config.jwt.player.admin, config.jwt.player.label),
    usersMiddlewares.updateNameValidations(), usersController.updateName);

router.put(
    "/updateEmail",
    verifyToken.verifyToken(config.jwt.player.admin, config.jwt.player.label),
    usersMiddlewares.updateEmailValidations(), usersController.updateEmail);
